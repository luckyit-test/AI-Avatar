...
const POSE_VARIATIONS = {
  ...
  single: [
    'стоит у елки, естественный взгляд',
    'сидит у камина, держа подарки',
    'стоит на балконе, естественный взгляд',
    'сидит на диване с новогодними игрушками',
    'стоит у окна, естественный взгляд',
...
Усы и борода должны выглядеть ИДЕНТИЧНО исходному фото во всех деталях.`;
  ...
  // Строгая инструкция по сохранению черт лица
...
Ракурс лица должен быть близок к исходному (не менять угол лица кардинально - если в исходнике анфас, то преимущественно анфас или легкий поворот; если профиль - преимущественно профиль; если три четверти - преимущественно три четверти). 
Направление взгляда должно быть естественным и близким к исходному (если в исходнике смотрит в камеру, то преимущественно в камеру или естественный взгляд вперед).`;
