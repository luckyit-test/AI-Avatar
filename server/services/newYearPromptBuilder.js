...
Атмосфера: сказочная, уютная, романтическая.`
  ...
  'city-street': {
    ...
    module: `КРИТИЧЕСКИ ВАЖНО: Это улица на открытом воздухе, НЕ помещение. Городская улица под открытым небом, украшенная новогодними огнями и декорациями. 
Местоположение: на улице, на открытом воздухе, под открытым небом, на городской улице, НЕ в помещении, НЕ в доме, НЕ в комнате, НЕ в здании. 
Новогодние элементы: новогодние огни на улице, снег на улице, праздничные украшения на улице, витрины магазинов, уличные новогодние декорации, небо над головой, городская улица. 
Атмосфера: праздничная, динамичная, городская, уличная, на открытом воздухе.`
  },
  
  'city-square': {
    name: 'Новогодняя площадь с елкой',
    module: `КРИТИЧЕСКИ ВАЖНО: Это площадь на открытом воздухе, НЕ помещение. Главная площадь города под открытым небом с большой новогодней елкой. 
Местоположение: на площади, на открытом воздухе, под открытым небом, на городской площади, НЕ в помещении, НЕ в доме, НЕ в здании, НЕ в зале. 
Новогодние элементы: огромная елка на площади, новогодние огни на улице, праздничные декорации на площади, каток на открытом воздухе, новогодние ярмарки на улице, небо над головой, открытое пространство. 
Атмосфера: торжественная, праздничная, массовая, уличная, на открытом воздухе.`
  },
  
  'outdoor-rink': {
    name: 'Каток под открытым небом',
    module: `КРИТИЧЕСКИ ВАЖНО: Это каток на открытом воздухе, НЕ помещение. Каток на улице под открытым небом с новогодним декором и освещением. 
Местоположение: на улице, на открытом воздухе, под открытым небом, на уличном катке, НЕ в помещении, НЕ в закрытом катке, НЕ в здании, НЕ в крытом помещении. 
Новогодние элементы: лед на открытом воздухе, новогодние огни вокруг катка на улице, елка рядом на улице, снег вокруг катка, зимняя атмосфера на открытом воздухе, небо над головой. 
Атмосфера: активная, веселая, зимняя, уличная, на открытом воздухе.`
  },
  
  'winter-forest': {
    name: 'Зимний лес с елкой',
    module: `КРИТИЧЕСКИ ВАЖНО: Это лес на открытом воздухе, НЕ помещение. Зимняя поляна в лесу под открытым небом с новогодней елкой. 
Местоположение: в лесу, на открытом воздухе, под открытым небом, на лесной поляне, НЕ в помещении, НЕ в доме, НЕ в здании, НЕ в комнате. 
КРИТИЧЕСКИ ВАЖНО - ТЕПЛАЯ ЗИМНЯЯ ОДЕЖДА: ОБЯЗАТЕЛЬНО теплая зимняя куртка или пуховик, теплая шапка, теплые варежки, теплые зимние сапоги или валенки, теплые носки, теплые зимние брюки, шарф. Одежда должна защищать от холода и мороза. СТРОГО ЗАПРЕЩЕНО: легкая одежда, летняя одежда, открытая одежда, платья без верхней одежды, короткие рукава, открытые ноги. 
Новогодние элементы: елка в лесу на открытом воздухе, снег в лесу, деревья вокруг, природная красота, уединение, сказка, небо над головой, открытое пространство леса. 
Атмосфера: сказочная, романтическая, природная, на открытом воздухе, лесная, зимняя, морозная.`
  },
...
Атмосфера: элегантная, торжественная, роскошная.`
  ...
  'cafe-restaurant': {
    ...
    module: `КРИТИЧЕСКИ ВАЖНО: Это СТРОГО кафе или ресторан, НЕ дом, НЕ квартира, НЕ гостиная, НЕ другое помещение. Профессиональное кафе или ресторан с новогодним убранством. 
Местоположение: СТРОГО в кафе, СТРОГО в ресторане, в заведении общественного питания, НЕ в доме, НЕ в квартире, НЕ в гостиной, НЕ в жилом помещении, НЕ в домашней обстановке. Должны быть видны элементы кафе/ресторана: столики для посетителей, стулья, барная стойка или стойка ресторана, меню, элементы заведения общественного питания. 
Новогодние элементы: новогодний декор в кафе/ресторане, праздничный стол в заведении, новогоднее меню, елка в кафе/ресторане, уютная атмосфера заведения. 
Атмосфера: уютная, романтическая, праздничная, ресторанная, кафешная.`
  },
  
  'theater': {
    name: 'Новогодний театр/концертный зал',
    module: `КРИТИЧЕСКИ ВАЖНО: Это театральный зал или концертный зал, НЕ домашняя обстановка. Профессиональный театральный зал или концертный зал с новогодним декором. 
Местоположение: СТРОГО в театре, СТРОГО в концертном зале, в театральном зале, в концертном зале, НЕ в доме, НЕ в квартире, НЕ в гостиной, НЕ в домашней обстановке, НЕ в жилом помещении. Должна быть видна сцена, театральные кресла, театральный зал, концертный зал. 
КРИТИЧЕСКИ ВАЖНО - ФОРМАЛЬНАЯ ОДЕЖДА: Одежда должна быть ФОРМАЛЬНОЙ и ЭЛЕГАНТНОЙ, подобающей для театра или концертного зала: элегантное вечернее платье, формальный костюм, классическая одежда, нарядная одежда для театра, элегантные туфли, формальные аксессуары. Одежда должна соответствовать торжественной атмосфере театра или концертного зала. СТРОГО ЗАПРЕЩЕНО: домашняя одежда, повседневная одежда, спортивная одежда, неформальная одежда, домашние тапочки, пижамы, халаты. 
Новогодние элементы: новогоднее представление на сцене, елка на сцене или в зале, праздничный декор в театре, торжественность, театральные декорации, новогоднее освещение в зале. 
Атмосфера: торжественная, элегантная, праздничная, формальная, театральная, концертная.`
  },
  
  'ski-resort': {
    name: 'Горнолыжный курорт',
    module: `КРИТИЧЕСКИ ВАЖНО: Это горнолыжный курорт на открытом воздухе, НЕ помещение. Горнолыжный курорт под открытым небом с новогодней атмосферой. 
Местоположение: на горнолыжном курорте, на открытом воздухе, под открытым небом, на склонах гор, НЕ в помещении, НЕ в доме, НЕ в здании. 
КРИТИЧЕСКИ ВАЖНО - ТЕПЛАЯ ГОРНОЛЫЖНАЯ ОДЕЖДА: ОБЯЗАТЕЛЬНО теплая горнолыжная куртка или пуховик, теплая шапка или шлем, теплые варежки, теплая горнолыжная обувь, теплые носки, теплые горнолыжные брюки или комбинезон, шарф. Защита от холода, ветра и мороза. СТРОГО ЗАПРЕЩЕНО: легкая одежда, летняя одежда, открытая одежда, обычная городская одежда. 
Новогодние элементы: елка на курорте на открытом воздухе, новогодние огни на улице, снег на склонах, горы вокруг, праздничная атмосфера, небо над головой. 
Атмосфера: активная, праздничная, курортная, уличная, на открытом воздухе, зимняя, горная.`
  },
  
  'park': {
    name: 'Новогодний парк/сквер',
    module: `КРИТИЧЕСКИ ВАЖНО: Это парк на открытом воздухе, НЕ помещение. Городской парк или сквер под открытым небом с новогодними украшениями. 
Местоположение: СТРОГО на улице, СТРОГО на открытом воздухе, СТРОГО под открытым небом, в парке на улице, в сквере на улице, НЕ в помещении, НЕ в доме, НЕ в здании, НЕ в закрытом пространстве, НЕ внутри здания, НЕ в комнате, НЕ в зале, НЕ в помещении. Фото должно быть СТРОГО на улице, на свежем воздухе, под открытым небом. 
КРИТИЧЕСКИ ВАЖНО - ТЕПЛАЯ ЗИМНЯЯ ОДЕЖДА: ОБЯЗАТЕЛЬНО теплая зимняя куртка или пуховик, теплая шапка, теплые варежки или перчатки, теплые зимние сапоги или ботинки, теплые носки, теплые зимние брюки, шарф. Одежда должна защищать от холода и мороза. СТРОГО ЗАПРЕЩЕНО: легкая одежда, летняя одежда, открытая одежда, платья без верхней одежды, короткие рукава, открытые ноги. 
Новогодние элементы: новогодние огни на деревьях в парке на улице, елка в парке на открытом воздухе, снег в парке на улице, праздничная атмосфера на улице, небо над головой, открытое пространство парка, уличная обстановка. 
Атмосфера: праздничная, игривая, семейная, уличная, на открытом воздухе, зимняя, на свежем воздухе.`
  },
...
Атмосфера: элегантная, роскошная, торжественная.`
  ...
  'balcony-terrace': {
    ...
    module: `КРИТИЧЕСКИ ВАЖНО: Это балкон или терраса на открытом воздухе, НЕ закрытое помещение. Балкон или терраса под открытым небом с видом на новогодний город. 
Местоположение: на балконе или террасе, на открытом воздухе, под открытым небом, с видом на улицу, НЕ в закрытом помещении, НЕ в комнате, НЕ внутри дома. 
Новогодние элементы: новогодние огни города на улице, елка на балконе или террасе, новогодние украшения на открытом пространстве, вид на праздник на улице, небо над головой, открытое пространство балкона/террасы. 
Атмосфера: романтическая, уютная, городская, на открытом воздухе, уличная.`
  },
...
Атмосфера: творческая, уютная, необычная.`
  ...
  'new-year-dacha': {
    ...
    module: `КРИТИЧЕСКИ ВАЖНО: Это дача на открытом воздухе или на веранде, НЕ закрытое помещение. Загородная дача с новогодним убранством и зимней атмосферой на открытом воздухе или открытой веранде. 
Местоположение: на даче на открытом воздухе, на открытой веранде, под открытым небом, на улице у дачи, НЕ в закрытом помещении, НЕ в комнате внутри дома, НЕ в закрытом здании. 
Новогодние элементы: елка на даче на открытом воздухе, деревянная открытая веранда, снег вокруг дачи, новогодние огни на улице, уютная дачная атмосфера на открытом воздухе, небо над головой, открытое пространство. 
Атмосфера: уютная, семейная, загородная, на открытом воздухе, уличная.`
  },
  
  'eiffel-tower': {
    name: 'Эйфелева башня',
    module: `КРИТИЧЕСКИ ВАЖНО: Это улица у Эйфелевой башни на открытом воздухе, НЕ помещение. Роскошная новогодняя атмосфера у Эйфелевой башни в Париже под открытым небом. 
Местоположение: на улице у Эйфелевой башни, на открытом воздухе, под открытым небом, в Париже, НЕ в помещении, НЕ в доме, НЕ в здании. 
КРИТИЧЕСКИ ВАЖНО: НЕ добавлять камин, НЕ добавлять камины, НЕ добавлять домашние элементы (камин, домашняя мебель, домашняя обстановка). Это улица, НЕ дом. 
Новогодние элементы: Эйфелева башня, новогодние огни, парижская атмосфера, праздничное освещение, роскошный декор, небо над головой. 
Атмосфера: роскошная, романтическая, торжественная, уличная, на открытом воздухе.`
  },
...
Атмосфера: роскошная, элегантная, торжественная.`
  ...
  'santa-residence': {
    ...
    module: `КРИТИЧЕСКИ ВАЖНО: Это волшебная резиденция Деда Мороза, большой новогодний склад, где готовят подарки для всех детей на свете. Сказочная атмосфера резиденции Деда Мороза. 
Местоположение: в резиденции Деда Мороза, в большом новогоднем складе подарков, в волшебной мастерской Деда Мороза, НЕ в обычном доме, НЕ в квартире, НЕ в обычном помещении. Должны быть видны элементы склада подарков: полки с подарками, коробки с подарками, новогодние игрушки, мастерская по изготовлению подарков, волшебная атмосфера склада. 
КРИТИЧЕСКИ ВАЖНО - СКАЗОЧНЫЕ ПЕРСОНАЖИ И ЭЛЕМЕНТЫ: На каждом фото должны быть 1-3 из следующих элементов: олени (живые олени или декорации оленей), сани (сани Деда Мороза), гномы (помощники Деда Мороза), Дед Мороз (сам Дед Мороз), Снегурочка (внучка Деда Мороза). Обязательно включить хотя бы один из этих элементов на каждом изображении. 
Новогодние элементы: резиденция Деда Мороза, большой новогодний склад подарков, волшебная елка, сказочные декорации, магия праздника, игрушки, подарки, полки с подарками, коробки с подарками, мастерская подарков, волшебная атмосфера. 
Атмосфера: сказочная, волшебная, детская, праздничная, магическая.`
  },
  
  'metro-new-year': {
    name: 'Новый год в метро',
    module: `КРИТИЧЕСКИ ВАЖНО: Это СТРОГО метро, подземная станция метро, НЕ другое помещение, НЕ дом, НЕ квартира, НЕ другое здание. Необычная новогодняя атмосфера в метро с праздничным декором. 
Местоположение: СТРОГО в метро, СТРОГО на станции метро, в подземной станции метро, в вагоне метро, на платформе метро, НЕ в доме, НЕ в квартире, НЕ в другом помещении, НЕ в обычном здании. Должны быть видны элементы метро: платформа метро, рельсы метро, вагоны метро, стены станции метро, указатели метро, элементы подземной станции, характерная архитектура метро. 
КРИТИЧЕСКИ ВАЖНО - ТЕПЛАЯ ОДЕЖДА: ОБЯЗАТЕЛЬНО теплая зимняя одежда: теплая куртка или пуховик, теплая шапка, теплые варежки или перчатки, теплая обувь, теплые носки, теплые брюки, шарф. Одежда должна защищать от холода. СТРОГО ЗАПРЕЩЕНО: легкая одежда, летняя одежда, открытая одежда. 
КРИТИЧЕСКИ ВАЖНО: НЕ добавлять камин, НЕ добавлять камины, НЕ добавлять домашние элементы (камин, домашняя мебель). Это метро, НЕ дом. 
Новогодние элементы: метро с новогодними украшениями, новогодние украшения в метро, праздничное освещение в метро, новогодний декор на станции метро, необычная новогодняя обстановка в метро, городская атмосфера метро. 
Атмосфера: необычная, современная, городская, подземная, метрошная.`
  }
};
...
НЕ изменять растительность на лице, НЕ добавлять растительность, если её нет в исходном фото, НЕ удалять растительность, если она есть в исходном фото.`;
  ...
  // Максимально строгая инструкция по сохранению черт лица с жесткой фиксацией ракурса и выражения
  const faceFeaturesInstruction = `КРИТИЧЕСКИ ВАЖНО: Сохранить ТОЧНЫЕ черты лица из исходного фото: форму лица, носа, губ, глаз, бровей, подбородка, скул, все пропорции, цвет глаз, цвет кожи, уникальные особенности. Ракурс головы СТРОГО ИДЕНТИЧЕН исходному (анфас/профиль/три четверти - как в оригинале). НЕ поворачивать голову, НЕ менять угол лица. Выражение лица ИДЕНТИЧНО исходному (улыбка/нейтральное - как в оригинале). НЕ изменять выражение, НЕ добавлять/убирать эмоции. Направление взгляда ИДЕНТИЧНО исходному. НЕ менять взгляд.`;
  ...
  if (isMultiple && people.length > 1) {
    ...
    return `${faceFeaturesInstruction} Сохранить прически всех ${people.length} человек, все уникальные особенности каждого человека. Каждый человек должен быть ИДЕНТИЧНО узнаваем как в исходном фото. Выражение лица каждого человека должно быть ИДЕНТИЧНО исходному фото. Ракурс головы каждого человека должен быть ИДЕНТИЧЕН исходному фото.${facialHairText}`;
  }
...
export function buildNewYearPrompts(analysisResult, styleId, locationId) {
  ...
  for (let i = 0; i < 6; i++) {
    ...
    // Убираем вариации эмоций - выражение лица строго фиксируется в инструкции по сохранению лица
    prompt = prompt.replace(/\[EMOTION_VARIATION\]/g, '');
    ...
    // Определяем, является ли локация уличной (разрешаем людей на заднем плане)
    const outdoorLocations = ['city-street', 'city-square', 'outdoor-rink', 'winter-forest', 'ski-resort', 'park', 'eiffel-tower', 'balcony-terrace', 'new-year-dacha'];
    const isOutdoorLocation = outdoorLocations.includes(locationId);
    
    // Добавляем строгую инструкцию о запрете других людей и животных, а также дублирования людей
    if (isOutdoorLocation) {
      // Для уличных локаций: разрешаем людей на заднем плане, но только на открытом воздухе
      prompt += ` КРИТИЧЕСКИ ВАЖНО: На переднем плане ТОЛЬКО люди и животные из исходного фото (каждый по одному разу, без дублирования). На заднем плане могут быть другие люди на улице, на открытом воздухе, но СТРОГО на улице, НЕ в помещении.`;
    } else {
      // Для помещений: строгий запрет на любых других людей
      prompt += ` КРИТИЧЕСКИ ВАЖНО: На фото ТОЛЬКО люди и животные из исходного фото (каждый по одному разу, без дублирования). НЕ добавлять других людей, НЕ добавлять людей на фон.`;
    }
    
    // Добавляем МАКСИМАЛЬНО СТРОГУЮ инструкцию об ориентации в несколько мест промпта
    const orientationText = variations.orientation === 'vertical' 
      ? 'КРИТИЧЕСКИ ВАЖНО - ОРИЕНТАЦИЯ ФОТО: Фото ДОЛЖНО быть СТРОГО ВЕРТИКАЛЬНЫМ (portrait orientation, вертикальная ориентация, высота больше ширины, соотношение сторон примерно 2:3 или 3:4). НЕ горизонтальное фото. Ширина должна быть МЕНЬШЕ высоты. Это ОБЯЗАТЕЛЬНОЕ требование.' 
      : 'КРИТИЧЕСКИ ВАЖНО - ОРИЕНТАЦИЯ ФОТО: Фото ДОЛЖНО быть СТРОГО ГОРИЗОНТАЛЬНЫМ (landscape orientation, горизонтальная ориентация, ширина больше высоты, соотношение сторон примерно 16:9 или 4:3). НЕ вертикальное фото. Высота должна быть МЕНЬШЕ ширины. Это ОБЯЗАТЕЛЬНОЕ требование.';
    
    // Добавляем в самое начало промпта (самое важное место)
    prompt = `${orientationText} ${prompt}`;
    
    // Добавляем в середину промпта (после описания локации)
    prompt = prompt.replace(
      /(\[LOCATION_MODULE\])/,
      `$1 ${orientationText}`
    );
    
    // Добавляем ориентацию и технические характеристики в конец промпта (повторяем для гарантии)
    prompt += ` КРИТИЧЕСКИ ВАЖНО - ОРИЕНТАЦИЯ ФОТО: ${variations.orientation === 'vertical' ? 'СТРОГО ВЕРТИКАЛЬНАЯ (portrait, высота больше ширины, соотношение сторон 2:3 или 3:4)' : 'СТРОГО ГОРИЗОНТАЛЬНАЯ (landscape, ширина больше высоты, соотношение сторон 16:9 или 4:3)'}. Это ОБЯЗАТЕЛЬНОЕ требование. Технические характеристики: ${variations.cameraSpecs.specs}.`;
