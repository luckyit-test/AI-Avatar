                    ...
                    if (order.status === 'paid' || order.status === 'processing' || order.status === 'completed') {
                        ...
                        try {
                            ...
                            if (raw) {
                                ...
                                if (data?.selectedRole  && data.selectedRole) {
                                    setSelectedRole(data.selectedRole);
                                }
                                if (data?.selectedCompany  && data.selectedCompany) {
                        ...
                        <AnimatePresence>
                            {(appState === 'idle' || appState === 'image-uploaded') && (
                                ...
                                >
                                    ...
                                    <div className="relative z-20 bg-white/90 backdrop-blur-sm rounded-xl border-2 border-dashed border-gray-300 p-6 w-full max-w-sm mx-auto lg:h-[334px] flex flex-col items-center justify-center">
