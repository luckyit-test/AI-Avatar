...
export const Icons = {
    ...
    headphones: (props: React.SVGProps<SVGSVGElement>) => (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M9 9V4.5M9 9H6.75A2.25 2.25 0 0 0 4.5 11.25v6A2.25 2.25 0 0 0 6.75 19.5H9M9 9h3m-3 10.5h3m-3-10.5V4.5m3 5.5V4.5m0 5.5h3.75A2.25 2.25 0 0 1 19.5 11.25v6A2.25 2.25 0 0 1 17.25 19.5H15m-3-10.5v10.5" />
        </svg>
    )
};
